...
const Tendencias = () => {
  ...
  const API_URL = `https://api.themoviedb.org/3/trending/movie/day?api_key=ecbcdcf9044928d12b179d9153f5a269&language=es-VE&page=${page}`;
  ...
  return (
    <section className="py-5 bg-dark text-white">
      <div className="container">
        ...
        <h2 className="text-center py-5 mb-0">Tendencias Del Dia</h2>
